...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\begin{minipage}{0.4\textwidth}
		\begin{flushright}
			\large
			\textit{Supervisor}\\
			\textsc{Jason Hearst}\\ % Supervisor's name
...
\setcounter{page}{1}
\input{0_Sections/1_Abstract.tex}
\input{0_Sections/2_Introduction.tex}
\input{0_Sections/3_Background.tex}
\input{0_Sections/4_Method.tex}
\input{0_Sections/5_Results.tex}
\input{0_Sections/6_Future_work.tex}
\input{0_Sections/7_Conclusion.tex}


\newpage
\input{X_Setup/reference.tex}
