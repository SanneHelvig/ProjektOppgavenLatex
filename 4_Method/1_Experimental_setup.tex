...
%Equipment can be placed inside the wind tunnel by removing a glass window. that in turn changes the position of the valves next to the motor inside the tunne
...
{\N} and 2.5 \si{\N}. %The force plate has an accuracy of ...  

%AD converter was configured to values corresponding to forces between -2.5N to 2.5N. 
